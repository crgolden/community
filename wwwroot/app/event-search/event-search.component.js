...
var event_search_service_1 = require('./event-search.service');
var EventSearchComponent = (function () {
    function EventSearchComponent(eventSearchService, router) {
        this.eventSearchService = eventSearchService;
        this.router = router;
        this.searchTerms = new Subject_1.Subject();
    }
    // Push a search term into the observable stream.
    EventSearchComponent.prototype.search = function (term) {
    ...
    EventSearchComponent.prototype.ngOnInit = function () {
        ...
        this.events = this.searchTerms
            ...
            ? _this.eventSearchService.search(term)
    ...
    EventSearchComponent.prototype.gotoDetail = function (event) {
